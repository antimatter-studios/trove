...
//!
//! Companion to `crates/troved/src/gpg_agent/assuan.rs`. The deeper coverage
//! lives in `crates/troved/fuzz/fuzz_targets/assuan_line_parse.rs` (libfuzzer,
//! nightly).
//!
...
use troved::gpg_agent::assuan::{percent_decode, percent_encode, Line, ParseError};
