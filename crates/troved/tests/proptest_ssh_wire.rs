...
//! `crates/troved/src/ssh_agent/wire.rs`. The deeper coverage lives in
//! `crates/troved/fuzz/fuzz_targets/ssh_wire_*.rs` (libfuzzer, nightly).
//!
...
//! denial-of-service against `troved`. Each property below pins down one
